...
2. `npm install` to install the node dependencies needed
3. Set up config for the MongoDB cluster. To do so, add a config.json file under /src/Config. config.example.json is a template that you can copy. Simply add the url to the plethora of X's.
